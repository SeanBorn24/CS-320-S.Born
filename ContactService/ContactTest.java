...
public class ContactTest {
	/*Test 1-5 tests to make
	 * sure the field does not become longer than the constraint 
	 * Test 6-9 tests ensure that each field is not null. ContactID is not tested for being not null because there isn't a way to
	 */
	@Test
